...
capture log close;
log using "..\datasets\logs\woman_wra.log", replace;
...
age_grp,
allocated_arm,
convert(smalldatetime,blood_cal_date_15b,121) as blood_cal_date_15b,
convert(smalldatetime,blood_cal_date_3b,121) as blood_cal_date_3b,
convert(smalldatetime,blood_cal_date_eb,121) as blood_cal_date_eb,
...
serf_2nd7hv_status,
serf_hv_rp_assmt
from [mindr-live].dbo.woman_wra
") dsn("rammps");


fixdate blood_cal_date_15b blood_cal_date_3b blood_cal_date_eb consent_date drf1_done_date drf2_done_date drf3_done_date saf_done_date serf_14d_done_date serf_7d_done_date serf_done_date serf_end_date serf_hv_done_date serf_start_date ses_done_date stool_cal_date_suf1 stool_cal_date_suf3 sudf1_done_date sudf2_done_date sudf3_done_date suf1_done_date suf2_done_date suf3_done_date urine_cal_date_suf1 urine_cal_date_suf2 urine_cal_date_suf3 wmf_done_date wra15b_done_date wra3b_done_date weaeb_done_date wravf1_1attm_date wravf1_done_date wravf2_done_date wravf3_done_date dvf_done_date eser_done_date px_done_date serf_2nd7hv_done_date ;

#delimit cr

save "..\datasets\stata\woman_wra.dta", replace
saveold "..\datasets\stata\woman_wra.dta",replace version(12)
