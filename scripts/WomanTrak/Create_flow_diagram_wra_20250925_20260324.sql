...
arm_wra,  /*keep*/
case
when allocated_arm ='W' then 'MN level 2'
when allocated_arm ='X' then 'Placebo'
when  allocated_arm ='Y' then 'MN level 3'
when  allocated_arm ='Z' then 'MN level 1' end as arm_wra_desc,
--dod,
