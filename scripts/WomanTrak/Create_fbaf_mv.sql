...
fbsex,
/*fbrelat1,*/
case when len(fbrelat1) >0 then substring(fbrelat1,1,1) else fbrelat1 end as fbrelat1,
case when len(fbrelat1) >2 then  substring(fbrelat1,3,1) else null end as fbrelat2,
case when len(fbrelat1) >4 then  substring(fbrelat1,5,1) else null end as fbrelat3,
fbstatus,
