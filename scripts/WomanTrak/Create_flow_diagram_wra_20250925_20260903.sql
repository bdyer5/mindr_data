...
when rp.uid ='206541' then 'bl' -- uid px baseline sample was used to make RP decision not ml sample 
when rp.uid ='916213' then null -- uid px RP decision occurred after endline. This woman is already in the analysis cohort and should not be considered discontinued.
...
-- update wtrak_wra_prep 
-- set supplementation_status = '7'
-- from  wtrak_wra_prep wt 
-- where wbb_status ='7'

-- update wtrak_wra_prep 
-- set supplementation_status = '6'
-- from  wtrak_wra_prep wt 
-- where wbb_status ='6'
...
from  wtrak_wra_prep wt 
where web_status = 6
and supplementation_status is null 


update wtrak_wra_prep 
set supplementation_status = '77'
from  wtrak_wra_prep wt 
where web_status = 7
and supplementation_status is null 
...
print 'adding parity '
print 'create a parity table from the WRA VF Enrollment form'

if exists(select o.name from sysobjects o where o.name='wra_live_born_cnt')
begin 
drop table wra_live_born_cnt
end 
go 
...
uid,
'1' as p_round,
wvep1mm as wepmm, --wvep1mm
wvep1yy as wepyy, --wvep1yy
wvep1outc as wepoutc, --wvep1outc
wvep1kids as wepkids, --wvep1kids
wvep1sex as wepsex, --wvep1sex
wvep1vit as wepvit, --wvep1vit
wvep1sex1 as wepsex1, --wvep1sex
wvep1vit1 as wepvit1, --wvep1vit1
wvep1sex2 as wepsex2, --wvep1sex2
wvep1vit2 as wepvit2, --wvep1vit2
wvep1sex3 as wepsex3, --wvep1sex3
wvep1vit3 as wepvit3 --wvep1vit3
into wra_live_born_cnt
from wravf_e_mv 
--where wvep1kids is not null
...
wvep2mm as wepmm,
wvep2yy as wepyy,
wvep2outc as wepoutc,
wvep2kids as wepkids,
wvep2sex as wepsex,
wvep2vit as wepvit,
wvep2sex1 as wepsex1,
wvep2vit1 as wepvit1,
wvep2sex2 as wepsex2,
wvep2vit2 as wepvit2,
wvep2sex3 as wepsex3,
wvep2vit3 as wepvit3
from wravf_e_mv 
...
wvep3mm as wepmm,
wvep3yy as wepyy,
wvep3outc as wepoutc,
wvep3kids as wepkids,
wvep3sex as wepsex,
wvep3vit as wepvit,
wvep3sex1 as wepsex1,
wvep3vit1 as wepvit1,
wvep3sex2 as wepsex2,
wvep3vit2 as wepvit2,
wvep3sex3 as wepsex3,
wvep3vit3 as wepvit3
from wravf_e_mv 
--where wvep3kids is not null
...
wvep4mm as wepmm,
wvep4yy as wepyy,
wvep4outc as wepoutc,
wvep4kids as wepkids,
wvep4sex as wepsex,
wvep4vit as wepvit,
wvep4sex1 as wepsex1,
wvep4vit1 as wepvit1,
wvep4sex2 as wepsex2,
wvep4vit2 as wepvit2,
wvep4sex3 as wepsex3,
wvep4vit3 as wepvit3
from wravf_e_mv 
--where wvep4kids is not null
...
wvep5mm as wepmm,
wvep5yy as wepyy,
wvep5outc as wepoutc,
wvep5kids as wepkids,
wvep5sex as wepsex,
wvep5vit as wepvit,
wvep5sex1 as wepsex1,
wvep5vit1 as wepvit1,
wvep5sex2 as wepsex2,
wvep5vit2 as wepvit2,
wvep5sex3 as wepsex3,
wvep5vit3 as wepvit3
from wravf_e_mv 
--where wvep5kids is not null
...
wvep6mm as wepmm,
wvep6yy as wepyy,
wvep6outc as wepoutc,
wvep6kids as wepkids,
wvep6sex as wepsex,
wvep6vit as wepvit,
wvep6sex1 as wepsex1,
wvep6vit1 as wepvit1,
wvep6sex2 as wepsex2,
wvep6vit2 as wepvit2,
wvep6sex3 as wepsex3,
wvep6vit3 as wepvit3
from wravf_e_mv 
--where wvep6kids is not null
...
wvep7mm as wepmm,
wvep7yy as wepyy,
wvep7outc as wepoutc,
wvep7kids as wepkids,
wvep7sex as wepsex,
wvep7vit as wepvit,
wvep7sex1 as wepsex1,
wvep7vit1 as wepvit1,
wvep7sex2 as wepsex2,
wvep7vit2 as wepvit2,
wvep7sex3 as wepsex3,
wvep7vit3 as wepvit3
from wravf_e_mv 
--where wvep7kids is not null
...
wvep8mm as wepmm,
wvep8yy as wepyy,
wvep8outc as wepoutc,
wvep8kids as wepkids,
wvep8sex as wepsex,
wvep8vit as wepvit,
wvep8sex1 as wepsex1,
wvep8vit1 as wepvit1,
wvep8sex2 as wepsex2,
wvep8vit2 as wepvit2,
wvep8sex3 as wepsex3,
wvep8vit3 as wepvit3
from wravf_e_mv 
--where wvep8kids is not null
...
wvep9mm as wepmm,
wvep9yy as wepyy,
wvep9outc as wepoutc,
wvep9kids as wepkids,
wvep9sex as wepsex,
wvep9vit as wepvit,
wvep9sex1 as wepsex1,
wvep9vit1 as wepvit1,
wvep9sex2 as wepsex2,
wvep9vit2 as wepvit2,
wvep9sex3 as wepsex3,
wvep9vit3 as wepvit3
from wravf_e_mv 
--where wvep9kids is not null
...
select uid, case when wepoutc=3 then 1 
when wepoutc=4 then 1 
else 0 
end as n_lb
from wra_live_born_cnt) a 
group by uid ) b on b.uid = w.uid 



update wtrak_wra_prep
set gravidity = wp.wveprvprn 
from wtrak_wra_prep w
left join wravf_e_mv wp on wp.uid = w.uid 
...
lsi = i.lsi
from wtrak_wra_prep w
left join indices_wra i on i.uid = w.uid 
...
arm_wra,  /*keep*/
case
when ltrim(rtrim(allocated_arm)) ='B' then 'MN level 2'
when ltrim(rtrim(allocated_arm)) ='D' then 'Placebo'
when  ltrim(rtrim(allocated_arm)) ='A' then 'MN level 3'
when  ltrim(rtrim(allocated_arm)) ='C' then 'MN level 1' end as arm_wra_desc,
--dod,
...
print 'baseline biospecimen -status'
select wt.arm_wra,wb_status,wbb_status,a.webblood1,wt.supp_status, count(*)
from wtrak_wra wt 
left join (select uid,webblood1 from wra_eb_mv we 
where we.webstatus = 1 and webblood1 in ('1','2'))
a on a.uid = wt.uid 
where wt.arm_wra is not null
group by wt.arm_wra,wb_status,wbb_status,a.webblood1,wt.supp_status
with rollup 


print 'has a baseline biospecimen'
select wt.arm_wra,wb_status,wbb_status, count(*)
from wtrak_wra wt 
right join (select uid from wra_eb_mv we 
where we.webstatus = 1 and webblood1 in ('1','2'))
a on a.uid = wt.uid 
where wt.arm_wra is not null
group by wt.arm_wra,wb_status,wbb_status
with rollup 
...
select wt.arm_wra,wb_status,wbb_status,wt.supp_status, count(*)
from wtrak_wra wt
where wt.arm_wra is not null
group by wt.arm_wra,wb_status,wbb_status,wt.supp_status
with rollup 
...
-- were dependent on field report for the pregnant status of women 


print 'women who have mid-line visits'
select arm_wra,supp_status,wm_status,wmb_status,mid_study_status,end_study_status,discnt,count(*)
from wtrak_wra wt
left join wra_log wl on wl.uid = wt.uid 
where wt.arm_wra is not null
and supp_status = '01'
group by arm_wra,supp_status,wm_status,wmb_status,mid_study_status,end_study_status,discnt
--with rollup
order by arm_wra 
