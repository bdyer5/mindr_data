...
if exists(select o.name from sysobjects o where o.name='aef_pw_mv')
begin 
drop view aef_pw_mv
end 
go 

create view aef_pw_mv as 
select 
ae.uid,
tlpin,
sector,
...
husbname,
idenconf,
convert(smalldatetime,ae.aefdate,121) as aefdate,
workerid,
aeperson,
childuid,
childname,
...
aeevent,
aediag,
convert(smalldatetime,aeondate,121) as aeondate,
aedescpt,
aefevntsum,
aelocate,
aeunexp,
