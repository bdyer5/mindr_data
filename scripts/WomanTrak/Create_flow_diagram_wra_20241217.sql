...
select allocated_arm,supp_status,wmb_status,count(*)
from wtrak_wra wt
where wt.allocated_arm is not null
and supp_status = '01'
group by allocated_arm,supp_status,wmb_status
with rollup
order by allocated_arm 


print 'mid-line visits'
select allocated_arm,wmb_status,count(*)
from wtrak_wra wt
where wt.allocated_arm is not null
and supp_status = '01'
and wmb_status = 1
group by allocated_arm,wmb_status
with rollup
order by allocated_arm 


print 'women who have mid-line visits'
select allocated_arm,supp_status,wm_status,wmb_status,mid_study_status,end_study_status,count(*)
from wtrak_wra wt
left join wra_log wl on wl.uid = wt.uid 
where wt.allocated_arm is not null
and supp_status = '01'
group by allocated_arm,supp_status,wm_status,wmb_status,mid_study_status,end_study_status
--with rollup
order by allocated_arm 
...
select allocated_arm,supp_status,we_status,web_status,end_study_status,count(*)
from wtrak_wra wt
--left join wra_log wl on wl.uid = wt.uid 
where wt.allocated_arm is not null
and supp_status = '01'
and wm_status =1 and wmb_status =1
group by allocated_arm,supp_status,we_status,web_status,end_study_status
with rollup
order by allocated_arm 
...
select allocated_arm,web_status,count(*)
from wtrak_wra wt
where wt.allocated_arm is not null
and supp_status = '01'
and wmb_status = 1
group by allocated_arm,web_status
with rollup
order by allocated_arm 
