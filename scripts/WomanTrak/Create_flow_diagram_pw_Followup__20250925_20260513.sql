...
when  allocated_arm ='Z' then 'MN level 1' end as arm_pw_desc,
/*age_grp,*/
/*dobyy,*/
/*dobdd,*/
/*dobmm,*/
...
print 'discontinuations throughout the study'
select rp.uid,w.allocated_arm,rp.eserdate,w.supp_status,w.saf_flow_status,w.mid_preg_status,w.late_preg_status,w.mbaf_status,*
from all_eser_pw rp
left join wtrak_pw w on w.uid = rp.uid 
