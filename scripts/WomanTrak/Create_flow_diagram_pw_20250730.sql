...
print 'mid pregnancy visit status'
select allocated_arm,saf_flow_status, mpf_status,mpf_status,mpb_status,w.bgoutc ,mid_preg_status,case when mid_preg_status =66 then 'Refused Continuation in the Study - Mid-pregnancy visit'
...
end as mid_preg_desc ,count(*) from wtrak_pw w
where pef_consent =1 
and saf_flow_status = 1
