...
consent,
consent_date,
wvfe_date as wravfe_date,
wvfe_status as wravfe_status,
web_date as wraeb_date,
web_status as wraeb_status,
wvf1_date as wravf15_date,
wvf1_status as wravf15_status,
w1b_date as wra15b_date,
w1b_status as wra15b_status,
mid_study_status,
wvf3_date as wravf3_date,
wvf3_status as wravf3_status,
w3b_date as wra3b_date,
w3b_status as wra3b_status,
end_study_status,
sesdate  as ses_date,
...
select wt.allocated_arm,wt.supp_status, count(*)
from wtrak_wra wt
where wt.allocated_arm is not null
...
select allocated_arm,supp_status,discnt,count(*)
from wtrak_wra wt
where wt.allocated_arm is not null
--and supp_status = '01'
group by allocated_arm,supp_status,discnt
with rollup
...
select allocated_arm,supp_status,wra15b_status,count(*)
from wtrak_wra wt
where wt.allocated_arm is not null
and supp_status = '01'
group by allocated_arm,supp_status,wra15b_status
with rollup
order by allocated_arm 
...
print 'women who have mid-line visits'
select allocated_arm,supp_status,wravf15_status,wra15b_status,mid_study_status,end_study_status,count(*)
from wtrak_wra wt
left join wra_log wl on wl.uid = wt.uid 
where wt.allocated_arm is not null
and supp_status = '01'
group by allocated_arm,supp_status,wravf15_status,wra15b_status,mid_study_status,end_study_status
--with rollup
order by allocated_arm 

select * from wtrak_wra 
where allocated_arm='W' and 
supp_status='01' and wravf15_status =1 and wra15b_status is null 


print 'women who have end-line visits'
select allocated_arm,supp_status,wravf3_status,wra3b_status,end_study_status,count(*)
from wtrak_wra wt
--left join wra_log wl on wl.uid = wt.uid 
where wt.allocated_arm is not null
and supp_status = '01'
and wravf15_status =1 and wra15b_status =1
group by allocated_arm,supp_status,wravf3_status,wra3b_status,end_study_status
with rollup
order by allocated_arm 
...
select allocated_arm,wra3b_status,count(*)
from wtrak_wra wt
where wt.allocated_arm is not null
and supp_status = '01'
and wra15b_status = 1
group by allocated_arm,wra3b_status
with rollup
order by allocated_arm 


print 'end-line visits status'
select allocated_arm,count(*)
from wtrak_wra wt
where wt.allocated_arm is not null
and supp_status = '01'
and wra15b_status = 1
