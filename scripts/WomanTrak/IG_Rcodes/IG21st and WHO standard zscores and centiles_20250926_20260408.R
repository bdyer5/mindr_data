...
kt_classified$sga3_ig <- case_when(
  is.na(kt_classified$birthweight_centile) ~NA,
  kt_classified$birthweight_centile < 0.03 ~ 1,
  kt_classified$birthweight_centile >= 0.03 ~ 0,
  TRUE ~NA
)
kt_classified$sga10_ig <- case_when(
  is.na(kt_classified$birthweight_centile) ~NA,
  kt_classified$birthweight_centile < 0.10 ~ 1,
  kt_classified$birthweight_centile >= 0.10 ~ 0,
  TRUE ~NA
)
...
write_dta(kt_classified_cut, "./output/mindr_gigs_20250926_20260408.dta")

write.csv(kt_classified_cut, "./output/mindr_gigs_20250926_20260408.csv", row.names = FALSE, na="")
